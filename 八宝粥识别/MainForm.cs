...
public partial class MainForm : Form
{
    ...
    private void DetectActionButton_Click(object sender, EventArgs e)
    {
        ...
        ImageDetectionTest.ModelInput sampleData = new ImageDetectionTest.ModelInput()
        {
            Image = image
        };
        ...
        foreach (var box in boxes)
        {
            ...
            #endregion
            int borderThickness = (int)(Math.Min(width, height) * 0.02);
            float fontSize = Math.Min(width, height) * 0.1f;
            ...
            var confidenceText = $"置信度: {box.Score:F2}";
